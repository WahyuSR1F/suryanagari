...
const paragraphs = [
  "Candi Tribuana Tunggadewi, atau yang dalam konteks lebih luas sering dikaitkan dengan Candi Rimbi, merupakan salah satu peninggalan bersejarah yang didedikasikan untuk menghormati Ratu Tribuana Tunggadewi. Beliau adalah penguasa perempuan Majapahit yang tangguh, ibunda dari Hayam Wuruk, dan sosok kunci yang membuka jalan menuju puncak kejayaan kerajaan melalui Sumpah Palapa Gajah Mada. Terletak di Desa Ngrimbi, Bareng, Jombang (rute kuno Trowulan menuju Malang/Kediri). Bangunan suci dari abad ke-14 ini menghadap ke barat dan berfungsi sebagai tempat pendarmaan. Uniknya, struktur luar dan relief menggunakan batuan andasit, sedangkan bagian dalamnya berbahan bata merah. Berdasarkan Kitab Negarakertagama, candi ini dibangun untuk memuliakan Tribhuwana Wijayatunggadewi (Ratu Majapahit ke-3, ibu Hayam Wuruk) setelah wafat (prahasta). Berdasarkan Kitab Negarakertagama, candi ini dibangun untuk memuliakan Tribhuwana Wijayatunggadewi (Ratu Majapahit ke-3, ibu Hayam Wuruk) setelah wafat (prahasta). Kaki candi dipahat dengan relief fabel Tantri Kamandaka sebagai metafora moral dan politik bagi para pemimpin kerajaan.",
  ...
  "Lebih dari sekadar struktur fisik, arsitektur peninggalan ini adalah representasi dari konsep 'Dewa Raja', di mana sang ratu setelah wafat dianggap bersatu dengan dewa sesembahannya. Arca Parwati yang ditemukan dalam kaitannya dengan Tribuana Tunggadewi menyimbolkan sang ratu sebagai manifestasi dewi kesuburan dan kekuatan feminin semesta (Shakti). Namanya dikaitkan dengan tokoh pewayangan Dewi Arimbi, dengan mitos candi ini dibangun dalam semalam oleh pasukan jin. Sering digunakan untuk meditasi oleh tokoh politik pada malam Jumat Legi atau Selasa Kliwon demi mencari energi kewibawaan (wahyu keprabon). Air di sekitar pondasi dipercaya memiliki energi penyembuh untuk meluruhkan sifat buruk (angkara murka) dalam diri manusia.",
