...
const paragraphs = [
  "Desa Bejijong dikenal sebagai 'Kampung Majapahit' karena rumah-rumah warganya dibangun bergaya arsitektur Majapahit. Selain sentra patung, desa ini juga menjadi rumah bagi pengrajin batik tulis khas Trowulan yang mengangkat motif-motif peninggalan kerajaan.",
  "Motif batik khas dari kawasan adalah Surya Majapahit, simbol matahari bersudut delapan yang dulu menjadi lambang kerajaan, serta motif sulur buah maja yg menjadi asal-usul nama 'Majapahit' karena rasa buahnya yang pahit.",
  "Proses pembuatan batik di sini bukan sekadar industri, melainkan prosesi seni yang sarat makna. Setiap canting yang digoreskan dan malam yang dilelehkan di atas kain katun mengandung doa dan pelestarian sejarah. Para pengrajin menggunakan pewarna alami dari ekstrak dedaunan, akar, dan kulit kayu untuk mereplikasi warna-warna membumi seperti cokelat soga (warna tanah), merah bata, dan nila pekat—warna-warna otentik dari masa lampau. Warna dominan batik Trowulan adalah merah bata dan hijau, berbeda dari batik daerah lain yang umumnya coklat sogan. Setidaknya tercatat 22 motif batik khas Mojokerto, beberapa bahkan terinspirasi kuliner lokal seperti sambal wader.",
  "Simbol Surya Majapahit dianggap wajib hadir di setiap kain batik Trowulan bagi pengrajin, simbol ini bukan sekadar hiasan, tapi identitas yang menyambungkan mereka dengan kejayaan leluhur Majapahit, sehingga selalu dipertahankan meski motif lain terus berkembang. Kampung Batik ini merupakan wujud nyata bagaimana seni Hindu-Buddha yang dulunya dipahat pada batu-batu candi yang kaku, kini bertransformasi menjadi mahakarya kain yang luwes dan bisa dipakai dalam keseharian. Ini adalah bukti bahwa peradaban Majapahit tidak mati bersama runtuhnya keraton, melainkan berevolusi dan hidup dalam nadi kebudayaan modern.",
