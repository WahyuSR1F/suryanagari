...
const paragraphs = [
  "Gapura Wringin Lawang, yang secara harfiah diterjemahkan sebagai 'Pintu Beringin', adalah gerbang monumetal (Gapura Bentar) terbesar yang masih berdiri dari era Majapahit. Terletak di Dukuh Wringin Lawang, Desa Jatipasar, Trowulan, Mojokerto. Berasal dari abad ke-14 (masa keemasan Majapahit), bangunan masif ini berwujud Gapura Candi Bentar (gerbang terbelah tanpa atap) setinggi 15,5 meter dengan fondasi meter dan lorong tengah selebar 3,5 meter. Ukurannya yang masif dan letaknya di utara mengindikasikan gapura ini sebagai gerbang protokoler utama (outer gate) menuju kediaman Gajah Mada atau kompleks utama Kraton. Merupakan prototipe asli arsitektur Candi Bentar yang hingga kini banyak ditemukan di pura-pura atau rumah adat di Bali.",
  ...
  "Ekskavasi radius 500 meter menemukan sumur tanah liat (jobong), lantai bata, dan sanitasi, bukti gerbang ini dulu berdiri di tengah kota urban yang padat. Teknik pembangunan gapura ini sangat mengagumkan. Struktur batu batanya disusun menggunakan teknik gosok tanpa menggunakan spesi semen modern, melainkan getah tumbuhan pelik untuk menyatukannya. Keakuratan presisi dari tumpukan bata ini menunjukkan tingginya keahlian arsitektur geometris para undagi (arsitek kuno) Majapahit pada abad ke-14.",
  "Banyak sejarawan meyakini bahwa Wringin Lawang adalah pintu masuk utama menuju pusat keraton atau kawasan permukiman penting para bangsawan dan mahapatih, mungkin kediaman Gajah Mada sendiri. Nama 'Pintu Beringin' berasal dari mitos sepasang pohon beringin kembar gaib penjaga kota yang dikawal makhluk halus berwujud prajurit kuno. Lorong tengahnya diyakini sebagai portal energi yang bisa memperlihatkan visualisasi masa lalu Majapahit jika dilewati pada jam sakral (seperti malam 1 Suro). Dianggap lokasi sakral tempat Gajah Mada mengikrarkan sumpah pasukannya; siapapun yang berbohong setelah bersumpah di sini dipercaya akan terkena petaka instan (tulah).",
